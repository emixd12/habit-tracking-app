...
| `/analytics` | implemented, protected | Basic completion counts, adherence, heatmaps, and behavior-day occurrence review for deliberate status and note corrections | No gamified streak language. |
