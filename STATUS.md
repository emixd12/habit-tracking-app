...
- The next implementation step is Ticket 009 from `docs/TICKETS.md`.
...
- For the next coding agent: begin with Ticket 009 unless a user explicitly asks for a different docs-only task.
